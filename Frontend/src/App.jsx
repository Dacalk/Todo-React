          ...
          {todos.length > 0 ? (
            todos.map((todo, index) => (
              ...
              >
                ...
                >
                  <div className={`h-5 w-5 rounded-full border-2 transition-all flex items-center justify-center ${todo.completed ? 'bg-prime-500 border-prime-500 shadow-[0_0_12px_rgba(139,92,246,0.6)]' : 'border-white/20 group-hover:border-prime-500/50'}`}>
                    {todo.completed && (
